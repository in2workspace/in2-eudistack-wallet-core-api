...
public interface PresentationService {
    ...
    Mono<String> createSignedTurnstileVerifiablePresentation(String processId, String authorizationToken, VerifiableCredential credentials, String nonce, String audience);
}
