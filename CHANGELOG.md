...
## [v2.0.8](https://github.com/in2workspace/in2-wallet-api/releases/tag/v2.0.8)
### Changed
- Refactored credential flow to return Flux instead of Mono<List>.
